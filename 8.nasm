;Write X86 menu driven Assembly Language Program (ALP) to implement OS (DOS) commands TYPE, COPY 
;and DELETE using file operations.User is supposed to providecommand line arguments in all cases. 
